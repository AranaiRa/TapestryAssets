...
[System.Serializable]
public class Tapestry_EffectBuilder_Payload_ModifyReach : Tapestry_EffectBuilder_Payload {
    ...
    public Tapestry_EffectBuilder_Payload_ModifyReach()
    {
        amount = 0.10f;
        id = "Generic";
    ...
    public override void Apply(Tapestry_Actor target)
    {
        if (target.GetType() == typeof(Tapestry_Player))
        {
            ...
            p.reach.AddBonus(amount, id, type, overwrite, overwriteByMag);
        }
    }
